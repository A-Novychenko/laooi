...
export const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  return (
    <div className="flex items-center gap-2 rounded-2xl bg-bgLightSlate p-4 md:p-5 xl:p-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-[8px] text-sm/[1.38] md:gap-[16px] xl:text-base/[1.38]">
          <Link
            href={fileUrl}
            target="_blank"
