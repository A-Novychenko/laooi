...
| `tag`       | `'h2'`      | required, `string`, specifies the HTML tag to render as (`h1`, `h2`, `h3`, etc.)                                                              |
| `style`     | `'second'`  | required, can take values `main`, `second`, or `third`, each representing different text styles for the title                                 |
